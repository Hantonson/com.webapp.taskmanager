<?php session_start();
    //require_once './controller/Voluntarios/C_Voluntarios.php';
...
<head>
    ...
    <link href="./assets/libraries/bootstrap-5.1.3-dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-F3w7mX95PdgyTmZZMECAngseQB83DfGTowi0iMjiWaeVhAn4FJkqJByhZMI3AhiU" crossorigin="anonymous">
    <script src="./assets/libraries/bootstrap-5.1.3-dist/js/bootstrap.bundle.min.js" integrity="sha384-/bQdsTh/da6pkI1MST/rWKFNjaCP5gBSY4sEBT38Q/9RBh9AH40zEOg7Hlq2THRZ" crossorigin="anonymous"></script>
    ...
    <div class="container-fluid">
        <div class="row g-0">
            <div class="col g-0">
                ...
                <img id="img1" src="./assets/img/slider/photo1.jpg" width="100%" height="100%">
